      ...
      <form onSubmit={handleSubmit} className="max-w-2xl space-y-5">
        ...
        <div>
          ...
          <textarea
            ...
            rows={15}
            className="w-full px-3 py-2 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-white text-sm font-mono focus:outline-none focus:ring-2 focus:ring-aurora-500 focus:border-transparent resize-y"
          />
        </div>
        ...
        <div className="flex items-center gap-3 pt-2">
          <button
            type="submit"
            disabled={saving}
            className="px-4 py-2 rounded-lg bg-aurora-500 hover:bg-aurora-400 disabled:opacity-50 text-white text-sm font-medium transition-all active:scale-[0.98]"
          >

...
INSERT INTO demos (title, description, video_url, embed_url, thumbnail_url, project_type, sort_order, is_published)
SELECT
  'Neural Aurora CRM — Full Demo',
  'See Neural Aurora CRM in action: shared inbox, contact management, sales pipelines, broadcasts, no-code automations, and the visual flow builder.',
  ...
  1,
  TRUE
WHERE NOT EXISTS (SELECT 1 FROM demos WHERE title = 'Neural Aurora CRM — Full Demo');
